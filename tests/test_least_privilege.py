...
class TestLeastPrivilegeCheck(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.router_data = {
            ...
            "device_type": "router",
            "configuration": {"roles": ["admin"], "auth": {"acl": {"allow": ["user1"]}}},
        }
        ...
        self.server_data = {
            ...
            "device_type": "server",
            "configuration": {"roles": ["user"], "auth": {"acl": {"allow": ["user2"]}}},
        }
    ...
    def test_least_privilege_compliance_router_user(self):
        ...
        mock_reporter.add_result.assert_called_with(
            "Router1", "Least Privilege", True, "Device has proper permissions for users: True."
        )
    ...
    def test_least_privilege_compliance_server_user(self):
        ...
        checker.run_least_privilege_check(mock_reporter)
        mock_reporter.add_result.assert_called_with(
            "Server1", "Least Privilege", True, "Device has proper permissions for users: True."
        )
    ...
    def test_least_privilege_non_compliance(self):
        ...
        checker.run_least_privilege_check(mock_reporter)
        mock_reporter.add_result.assert_called_with(
            "Router1", "Least Privilege", False, "Device has proper permissions for users: False."
        )
